  ...
  it("queues removed listing media after a successful update", async () => {
            ...
            return {
              ...
              maybeSingle: vi.fn().mockResolvedValue({
                data: {
                  ...
                  status: "live",
                  area: "MZANSI_MARKET",
                  photos: ["https://media.verifymzansi.co.za/listings/old-photo.jpg"],
                  videos: ["https://media.verifymzansi.co.za/listings/old-video.mp4"],
                  video_thumbnail: "https://media.verifymzansi.co.za/listings/old-thumb.jpg",
                },
              }),
            };
          }
    ...
    const res = await updateListing(
      createRequest(`http://localhost:3000/api/listings/${VALID_UUID}`, "PUT", {
        ...
        images: ["https://media.verifymzansi.co.za/listings/new-photo.jpg"],
        videos: [],
      }),
  ...
  it("queues removed promotion media after a successful update", async () => {
            ...
            return {
              ...
              maybeSingle: vi.fn().mockResolvedValue({
                data: {
                  ...
                  seller_id: USER_ID,
                  status: "live",
                  photos: ["https://media.verifymzansi.co.za/promotions/old-photo.jpg"],
                  videos: ["https://media.verifymzansi.co.za/promotions/old-video.mp4"],
                  video_thumbnail: "https://media.verifymzansi.co.za/promotions/old-thumb.jpg",
                },
              }),
            };
          }
    ...
    const res = await updatePromotion(
      createRequest(`http://localhost:3000/api/promotions/${VALID_UUID}`, "PUT", {
        ...
        images: ["https://media.verifymzansi.co.za/promotions/new-photo.jpg"],
        videos: [],
      }),
      { params: Promise.resolve({ id: VALID_UUID }) }
    );
            ...
            return {
              ...
              maybeSingle: vi.fn().mockResolvedValue({
                data: {
                  ...
                  seller_id: USER_ID,
                  status: "draft",
                  logo_url: "https://media.verifymzansi.co.za/business/logo.jpg",
                  cover_photo: "https://media.verifymzansi.co.za/business/cover.jpg",
                  cover_video: "https://media.verifymzansi.co.za/business/cover.mp4",
                  video_thumbnail: "https://media.verifymzansi.co.za/business/thumb.jpg",
                  gallery_photos: ["https://media.verifymzansi.co.za/business/gallery-1.jpg"],
                },
              }),
            };
          }
  ...
  it("queues removed business media after a successful update", async () => {
            ...
            return {
              ...
              maybeSingle: vi.fn().mockResolvedValue({
                data: {
                  ...
                  status: "live",
                  logo_url: null,
                  cover_photo: "https://media.verifymzansi.co.za/business/old-cover.jpg",
                  cover_video: null,
                  video_thumbnail: null,
                  gallery_photos: ["https://media.verifymzansi.co.za/business/old-gallery.jpg"],
                },
              }),
            };
          }
    ...
    const res = await updateBusiness(
      createRequest(`http://localhost:3000/api/businesses/${VALID_UUID}`, "PATCH", {
        ...
        gallery_photos: ["https://media.verifymzansi.co.za/business/new-gallery.jpg"],
        cover_photo: "https://media.verifymzansi.co.za/business/new-cover.jpg",
      }),
      { params: Promise.resolve({ id: VALID_UUID }) }
    );
