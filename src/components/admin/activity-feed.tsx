...
const ACTION_LABELS: Record<string, string> = {
  ...
  listing_boosted: "Listing boost purchased",
  listing_featured: "Listing feature purchased",
  listing_urgent: "Listing urgent purchased",
  promotion_boosted: "Tourism & Events boost purchased",
  promotion_featured: "Tourism & Events feature purchased",
