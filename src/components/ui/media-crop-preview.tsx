...
interface MediaCropPreviewProps {
  ...
  file: File;
  /** Target aspect ratio for the crop overlay (default: 4/5). */
  aspectRatio?: number;
 ...
 *
 * Shows the full uploaded image with a semi-transparent 4:5 (or custom)
...
export function MediaCropPreview({
  ...
  const overlayLabel = useMemo(() => {
    ...
    if (aspectRatio === 16 / 9) return "16:9 hero";
