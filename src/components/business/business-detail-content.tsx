          ...
          {showPromotions &&
            (promotions.length > 0 ? (
              <div className="space-y-4">
                <h3 className="px-1 font-display text-xl font-bold">Tourism & Events posts</h3>
              ...
              <div className="rounded-xl border border-dashed bg-muted/30 p-6 text-center">
                ...
                <h4 className="mb-1 text-lg font-medium">Tourism & Events posts</h4>
                <p className="mx-auto max-w-sm text-muted-foreground">
                  This business has not posted any Tourism & Events posts yet.
                </p>
              </div>
            ))}
        </div>
