-- Fix insert_promotion_with_limit: social authorization columns NOT NULL DEFAULT
-- were added in 20260323000000_promotion_social_distribution_authorization.sql,
-- but the atomic insert function doesn't set them, and jsonb_populate_record
-- fills missing keys with NULL, overriding the column defaults.
--
-- This causes promotion creation to fail with:
--   23502: null value in column "social_distribution_authorized" violates not-null constraint
